...
var ReligiousEdForm = /** @class */ (function () {
    ...
    ReligiousEdForm.prototype.SetReligiousEdFormFields = function () {
        var formFields = new ReligiousFormFields();
    ...
    ReligiousEdForm.prototype.SendEmail = function () {
        var religiousEdData = $.param(this.SetReligiousEdFormFields());
        var url = UrlConstants.URL + this.religiousEdSendEmailUrl;
        var returnMessage = EmailHelper.SendEmail(url, religiousEdData, 'religioused');
...
//# sourceMappingURL=ReligiousEd.js.map